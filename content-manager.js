...
const REMOTE_URL=/\/admin\/?(?:index\.html)?$/.test(location.pathname)?'../data/content.json':'data/content.json';
const defaults={
 ...
 program:{image1:'assets/activity.jpg',image2:'assets/food-play.jpg',image3:'assets/garden.jpg'},
...
function hasLocal(){return localStorage.getItem(KEY)!==null}
...
window.HappyCMS={KEY,defaults,get,set,reset,render,loadRemote,publicPath,hasLocal};
